...
class CartillasController extends ControladorBase{
    ...
    public function index(){
        if(Session::get('level')=='admin'){
            ...
            $user= new Usuario;
            $allcartillas=$cartilla->getCartilla();
    ...
    public function create(){   
        $cartilla= new Cartilla;
        $users=$cartilla->getAllByTable('users');
        $planes=$cartilla->getAllByTable('planes');
        $this->view("formCartilla",array("planes"=>$planes, "users"=>$users));
    }
