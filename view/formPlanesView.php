    ...
    <div class="container-fluid">
      ...
      <div class="card mb-3">
        <div class="card-header">
            <i class="fa fa-user-plus"></i> Registro de nuevo plan</div>
        <div class="card-body">
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-4">
                             <div class="form-group">
                                ...
                                <input class="form-control" id="exampleInputValor" type="text" name="valor_plan" aria-describedby="valor_plan" placeholder="Valor del plan">
                             </div>
                        </div>
                        <div class="col-md-4">
                             <div class="form-group">
